local tooltips_hud = function(v, player)
	...
	local ese = PTSR.pizzatime_tics < pthud_expectedtime -- y axis tween
					and
					( ease.linear(div, pthud_start_pos+pthud_offset, pthud_finish_pos+pthud_offset) )
					or 
					( pthud_finish_pos+pthud_offset )
